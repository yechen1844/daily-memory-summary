/*
 * 手账日记 (daily-memory-summary) v2.7.5
...
(function () {
  ...
  var DEFAULT_SETTINGS = {
    ...
    charThinkingChain: [
      ...
      "",
      "6. 段落组织（重要）",
      "   - 严格按照输出格式中给出的固定结构（## 关键事件与内心想法 / ## 情感与关系 / ## 重要承诺与伏笔 / ## 内心活动 / ## 值得记录的我与ta的聊天记录）逐项填写。",
      "   - 每个板块内用自然的换行分段来组织内容，每段聚焦一个事件、场景或情绪转折，让日记像真实的手写日记那样自然流畅。",
      "   - 不要遗漏任何板块，不要使用固定结构之外的额外标题。",
      "",
      "其他要求：",
      "- 称呼user时，可以用ta",
      ...
      "- 核心：情感必须健康积极，尊重彼此，禁止对 user 使用“小祖宗、小祸害、小狐狸”这类带刻板印象的称呼。"
    ].join("\n"),
    charFormat: "请直接以 {{char}} 的第一人称写日记，按照思维链中的要求，用以下固定结构输出：\n\n【日期】YYYY-MM-DD \n[人物]的日记\n\n## 关键事件与内心想法\n[按时间线叙述当天互动，夹杂心理活动]\n\n## 情感与关系\n[对彼此互动模式的归纳、角色分配、关系变化]\n\n## 重要承诺与伏笔\n[明确的约定、未来计划、值得记住的承诺]\n\n## 内心活动\n[宏观的情绪感受、对关系的审视、自白式总结]\n\n## 值得记录的我与ta的聊天记录\n[原话摘录]",
